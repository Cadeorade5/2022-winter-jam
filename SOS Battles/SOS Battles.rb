...
# * Hash containing base species call rates
  SOS_WHITELIST_RATES={ :EEVEE => 100, :SPIRITOMB => 100, :SANDILE => 50, :ORTHWORM => 50, :SIZZLIPEDE => 50, :SCRAGGY => 50, :MUDBRAY => 50, :PINSIR => 50,
:TRAPINCH => 50, :SILICOBRA => 50, :GRUBBIN => 50,  :GOLETT => 50,  :SIGILYPH => 50,  :YAMASK => 50,  :BALTOY => 50,  :CHARCADET => 50,  :ABRA => 50,
:UNOWN => 50,  :LARVESTA => 50,  :HIPPOPOTAS => 50
}
...
# * If using the Blacklist, all Pokemon have the same rate of being called.
  ...
  SOS_CALL_MONS={
    :EEVEE=>[:EEVEE,:EEVEE,:EEVEE,:ESPEON,:UMBREON,:VAPOREON],
    :SPIRITOMB=>[:UNOWN,:UNOWN,:UNOWN,:SPIRITOMB,:SPIRITOMB,:MIMIKYU],
    :SANDILE=>[:SANDILE,:SANDILE,:SANDILE,:KROKOROK,:KROKOROK,:KROOKODILE],
    :ORTHWORM=>[:ORTHWORM,:ORTHWORM,:ORTHWORM,:TOEDSCOOL,:TOEDSCOOL,:TORKOAL],
    :SIZZLIPEDE=>[:SIZZLIPEDE,:SIZZLIPEDE,:SIZZLIPEDE,:SHUCKLE,:SHUCKLE,:CENTISKORCH],
    :SCRAGGY=>[:SCRAGGY,:SCRAGGY,:SCRAGGY,:IMPIDIMP,:IMPIDIMP,:SCRAFTY],
    :MUDBRAY=>[:MUDBRAY,:MUDBRAY,:MUDBRAY,:TAUROS,:TAUROS,:MUDSDALE],
    :PINSIR=>[:PINSIR,:PINSIR,:PINSIR,:HERACROSS,:HERACROSS,:GLIGAR],
    :TRAPINCH=>[:TRAPINCH,:TRAPINCH,:TRAPINCH,:VIBRAVA,:VIBRAVA,:FLYGON],
    :SILICOBRA=>[:SILICOBRA,:SILICOBRA,:SILICOBRA,:CYCLIZAR,:CYCLIZAR,:SANDACONDA],
    :GRUBBIN=>[:GRUBBIN,:GRUBBIN,:GRUBBIN,:CHARJABUG,:CHARJABUG,:VIKAVOLT],
    :GOLETT=>[:GOLETT,:GOLETT,:GOLETT,:LARVESTA,:LARVESTA,:GOLURK],
    :SIGILYPH=>[:SIGILYPH,:SIGILYPH,:SIGILYPH,:NATU,:NATU,:XATU],
    :YAMASK=>[:YAMASK,:YAMASK,:YAMASK,:HAUNTER,:HAUNTER,:RUNERIGUS],
    :BALTOY=>[:BALTOY,:BALTOY,:BALTOY,:ABSOL,:ABSOL,:CLAYDOL],
    :CHARCADET=>[:CHARCADET,:CHARCADET,:CHARCADET,:CYCLIZAR,:CYCLIZAR,:ARMAROUGE],
    :ABRA=>[:ABRA,:ABRA,:ABRA,:KADABRA,:KADABRA,:ALAKAZAM],
    :UNOWN=>[:UNOWN,:UNOWN,:UNOWN,:SIGILYPH,:SIGILYPH,:CARBINK],
    :LARVESTA=>[:LARVESTA,:LARVESTA,:LARVESTA,:MRMIME,:MRMIME,:VOLCARONA],
    :HIPPOPOTAS=>[:HIPPOPOTAS,:HIPPOPOTAS,:HIPPOPOTAS,:TORKOAL,:TORKOAL,:HIPPOWDON],
  }
